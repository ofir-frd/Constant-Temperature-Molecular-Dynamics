...
function Project_a(btnDimentionsValue,btnValParticles,btnValInitialTemp)
...
% relaying on the particles current speeds
...
%%Receives   initial temperature and set initial velocities to the particles 
%initial velocities are based on the equation:
% kb*T(t)=sum(M*V^2)/N*d
%kb=Boltzmann constant,M=mass,V=velocity, N=total particles, d=amount of dimensions
